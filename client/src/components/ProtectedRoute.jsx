...
const ProtectedRoute = ({ allowedRoles }) => {
  ...
  if (allowedRoles && !allowedRoles.includes(userRole)) {
    ...
    // You could also render an "Access Denied" page directly here.
    return (
      <div style={{
          display: 'flex',
          ...
          <p style={{ fontSize: '1em', marginTop: '10px' }}>Your role: <strong>{userRole || 'N/A'}</strong></p>
          {/* Optional: Add a button to redirect to a more appropriate page for their role */}
          <button
