...
const RootApp = () => {
    // NEW: Destructure currentUser, loading, logout, userRole from useAuth() hook
    const { currentUser, loading, logout, userRole } = useAuth();

    // NEW: Display loading state while authentication is being initialized
    if (loading) {
        return (
    ...
    // NEW: Fixed header element to display user info and logout button when logged in
    ...
    return (
        <div className="font-inter">
            ...
            <Routes>
                ...
                {/* NEW: Root path: Redirects to /app if authenticated, otherwise to /login */}
                ...
                {/* NEW: Protected Routes using the imported ProtectedRoute component */}
